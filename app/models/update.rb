class Update < ApplicationRecord
  ...
  private
    ...
    def calculate_new_cases_growth_rate
      ...
      current_update_new_cases  = current_update.sum(:cases).to_f
      previous_update_new_cases = previous_update.sum(:cases).to_f
      next_update_new_cases = next_update.sum(:cases).to_f
